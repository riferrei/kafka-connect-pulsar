...
public class PulsarSourceConnectorConfig extends AbstractConfig {
    ...
    private static final String PROTOBUF_JAVA_MESSAGE_CLASS_DEFAULT = null;
    ...
    private static final String TOPIC_NAMING_STRATEGY_DEFAULT = TopicNamingStrategy.NameOnly.name();
    ...
    private static void addBasicOptions(final ConfigDef configDef) {
        ...
        .define(
            ...
            Type.BOOLEAN,
            MESSAGE_DESERIALIZATION_ENABLED_DEFAULT,
            Importance.HIGH,
            MESSAGE_DESERIALIZATION_ENABLED_DOC)
        .define(
            PROTOBUF_JAVA_MESSAGE_CLASS_CONFIG,
            Type.STRING,
            PROTOBUF_JAVA_MESSAGE_CLASS_DEFAULT,
            Importance.HIGH,
            PROTOBUF_JAVA_MESSAGE_CLASS_DOC)
        .define(
