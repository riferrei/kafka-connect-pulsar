...
public class PulsarSourceConnectorConfig extends AbstractConfig {
    ...
    private static final String SCHEMA_DESERIALIZATION_ENABLED_DOC = "If enabled, messages serialized with JSON, Avro, or ProtoBuf will be transformed into struct-based records";
    private static final boolean SCHEMA_DESERIALIZATION_ENABLED_DEFAULT = false;

    public static final String PROTOBUF_JAVA_GENERATED_CLASS_CONFIG = "protobuf.java.generated.class";
    private static final String PROTOBUF_JAVA_GENERATED_CLASS_DOC = "Java class generated by the protoc compiler that holds the message types";
    private static final String PROTOBUF_JAVA_GENERATED_CLASS_DEFAULT = null;
    ...
    private static void addBasicOptions(final ConfigDef configDef) {
        ...
        .define(
            PROTOBUF_JAVA_GENERATED_CLASS_CONFIG,
            Type.STRING,
            PROTOBUF_JAVA_GENERATED_CLASS_DEFAULT,
            Importance.HIGH,
            PROTOBUF_JAVA_GENERATED_CLASS_DOC)
        .define(
